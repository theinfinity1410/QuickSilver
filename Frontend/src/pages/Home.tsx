...
import { Wand2 } from 'lucide-react'; // Keeping in case it's used elsewhere
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-100 mb-4">QuickSilver</h1>
          ...
          <div className="flex justify-center gap-4 mt-4">
            <button
              ...
              className="bg-blue-600 text-gray-100 py-3 px-6 rounded-lg font-medium hover:bg-blue-700 transition-colors"
              aria-label="Login"
            >
              Login
            </button>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="bg-gray-800 rounded-lg shadow-lg p-6">
            ...
            <button
              ...
              aria-label="Generate Website Plan"
            >
